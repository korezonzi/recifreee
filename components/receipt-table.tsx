...
export function ReceiptTable({
  ...
  const allSelected =
    receipts.length > 0 && selectedIds.size === receipts.length;
  ...
  }, [allSelected, receipts, onSelectionChange]);
          ...
          <tbody>
            {receipts.map((r) => (
              <tr key={r.id} className="border-b last:border-0 hover:bg-muted/30">
                ...
                <td className={cn("p-2", confidenceBg(r.ocr.date, r.ocr.confidence.date))}>
                  <Input
                    type="date"
                    value={r.ocr.date || ""}
                    onChange={(e) =>
                ...
                <td className={cn("p-2", confidenceBg(r.ocr.vendor, r.ocr.confidence.vendor))}>
                  <Input
                    value={r.ocr.vendor || ""}
                    onChange={(e) =>
                ...
                <td className={cn("p-2", confidenceBg(r.ocr.amount, r.ocr.confidence.amount))}>
                  <Input
                    type="number"
                    value={r.ocr.amount ?? ""}
                    onChange={(e) =>
